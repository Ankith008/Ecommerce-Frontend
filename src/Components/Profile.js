...
export default function Profile() {
  ...
  const handleupdateSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await axiosPrivate.post("auth/comupdate", {
        ...updatedata,
        id: currentid,
      });
  ...
  const finddetails = async () => {
    try {
      ...
      setCurrentid(response.data.company.id);
      setformvalues(response.data.company);
    } catch (error) {
        ...
        <div className="outerup">
          ...
          <form className="upform" onSubmit={(e) => handleupdateSubmit(e)}>
            ...
            <input
              ...
              value={updatedata.name || formvalues.companyname}
              onChange={(e) => {
                onchange(e);
              }}
              required
            ...
            <input
              ...
              value={updatedata.email || formvalues.companyemail}
              onChange={(e) => {
                onchange(e);
              }}
              required
            ...
            <input
              ...
              value={updatedata.address || formvalues.companylocation}
              onChange={(e) => {
                onchange(e);
              }}
              required
            ...
            <input
              ...
              value={updatedata.phoneNumber || formvalues.companyownernumber}
              onChange={(e) => {
                onchange(e);
              }}
              required
